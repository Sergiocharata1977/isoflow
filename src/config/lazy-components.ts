...
export const lazyComponents = {
  ...
  ObjetivosListing: lazy(() => import("../components/procesos/ObjetivosListing")),
  IndicadoresListing: lazy(() => import("../components/procesos/IndicadoresListing")),
  MedicionesListing: lazy(() => import("../components/procesos/MedicionesListing")),
